...
.label allocproc
mul r1, r0, 32       // mul by sizeof ptable entry
mva r2, ptable
...
str r3, [r2, 24]       // stro to p->tf
sub r3, r3, 48    // sub sizeof context, r3 has addr of context
str r3, [r2, 28]  // str to p->context
str r0, [r2, 20]       // str to p->kstack - WRONG
ldr r0, [sp], 4             // retrieve addr of kstack from stack
str r0, [r2, 8]   // str to p->kstack
mva r1, forkret
str r1, [r3, 44]    // str to p->context->pc
mva r1, trapret
